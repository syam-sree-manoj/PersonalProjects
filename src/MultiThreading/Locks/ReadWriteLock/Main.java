...
import MultiThreading.Locks.ReadWriteLock.SharedResource;
...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread t2 = new Thread(() -> sharedResource1.addItem(lock), "Thread-2");

        Thread t3 = new Thread(() -> sharedResource2.consumeItem(lock), "Thread-3");
